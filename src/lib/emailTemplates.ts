...
/**
 * Generates HTML for application received confirmation email
 */
export const generateApplicationReceivedEmail = (data: ApplicationReceivedEmailData): string => {
  const roleTitle = data.role === 'publisher' ? 'Publisher' : 'Retailer'
...
export const EMAIL_SUBJECTS = {
  ...
  applicationReceived: (businessName: string) => `We've Received Your Application - ${businessName}`,
}
