...
import { BackNavigation, ButtonSecondary } from "@/components/neesh";
          ...
          {isLoading ? (
            ...
            <div className="card-neesh">
              <div className="flex items-start gap-4 p-4 bg-yellow-500/10 rounded-lg border border-yellow-500/30">
                ...
                <div>
                  <h3 className="font-medium text-foreground">Stripe Account Not Connected</h3>
                  <p className="text-muted-foreground mt-1">
                    Your account is not yet connected to Stripe. Please contact support to initiate the onboarding process.
                  </p>
                </div>
              </div>
            </div>
